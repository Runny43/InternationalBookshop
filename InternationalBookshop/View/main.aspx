        ...
        <div>
            <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
                <div class="container-fluid">
                    <a runat="server" id="UserNameIfLogged" class="navbar-brand" href="#">Biblioteca Internacional</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarColor01">
                        <ul class="navbar-nav me-auto">
                            <li class="nav-item">
                                <a class="nav-link active" href="Bill.aspx">Home
                <span class="visually-hidden">(current)</span>
                            ...
                            <input runat="server" id="txtSearch" class="form-control me-sm-2" type="search" placeholder="Search" />
                            <button runat="server" id="btnSearch" class="btn btn-secondary my-2 my-sm-0" type="submit" onserverclick="btnSearch_ServerClick">Search</button>
                        ...
                        <ItemTemplate>
                            <div class="card" style="width: 18rem; margin-left: 12px">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="bookDetails.aspx?id=<%# Eval("bookid")%>" class="btn btn-primary">Book for $<%# Eval("price")%> /p</a>
                                </div>
                            </div>
                        </ItemTemplate>
